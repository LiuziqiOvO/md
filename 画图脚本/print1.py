...
legend = ax.legend(loc=(0, 1), ncol=4, frameon=False, columnspacing=0.5)
...
plt.savefig('zone_bw.svg', format='svg')
...
plt.savefig('zone_iops.svg', format='svg')
